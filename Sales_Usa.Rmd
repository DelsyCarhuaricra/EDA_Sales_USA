...
## Variable Cantidad (de productos de categoría "Mobiles & Tablets") :
...
ventas_categoria <- data.frame(categoria,ventas)
diagramaCat_Venta <-  aggregate(x=ventas_categoria$ventas, by=list(ventas_categoria$categoria),FUN = sum)
diagramaCat_Venta[order(diagramaCat_Venta$x,decreasing = TRUE),] %>% top_n(1) #Como pondemos ver la categoría mas vendida es mobiles and tables
...
#Parameters : 
#Loglikelihood:  -72715.63   AIC:  145435.3   BIC:  145453.3 
#Correlation matrix:
#         shape     rate
#shape 1.000000 0.964706
#rate  0.964706 1.000000
...
#Loglikelihood:  -66732.52   AIC:  133469   BIC:  133487.1 
#Correlation matrix:
#             meanlog        sdlog
#meanlog 1.000000e+00 5.121939e-12
#sdlog   5.121939e-12 1.000000e+00
...
#Parameters : 
#:  -88102.85   AIC:  176209.7   BIC:  176227.8 
#Correlation matrix:
#          shape     scale
#shape 1.0000000 0.3338363
#scale 0.3338363 1.0000000
...
> **Conclusión**: Teniendo en cuenta el gráfico de Cullen y Frey así como el criterio del menor AIC, podemos decir que la variable venta sigue una distribución Lognormal

En este momento, decidimos hacer una estimación de la variable cantidad para el año siguiente de los productos de categoría "Mobiles & Tablets". Para ello, vamos a considerar una muestra de 360 días y los parámetros de la distribución log normal
...
> **Conclusión**: Después de obtener la estimación de la variable cantidad para el año siguiente y el intervalo de confianza, concluimos que el año que viene el promedio de cantidad solicitada por ordenes de tables es de dos unidades por cantidad
...
#Explanation why i'm using /1000 in fitdist #https://stackoverflow.com/questions/53557022/error-code-100-fitting-exp-distribution-using-fitdist-in-r
#Fitting of the distribution ' gamma ' by maximum likelihood 
#Parameters : 
#Loglikelihood:  -92309.09   AIC:  184622.2   BIC:  184640.5 
#Correlation matrix:
#          shape      rate
#shape 1.0000000 0.6621424
#rate  0.6621424 1.0000000
...
#Parameters : 
#Loglikelihood:  -85848.96   AIC:  171701.9   BIC:  171720.2 
#Correlation matrix:
#              meanlog         sdlog
#meanlog  1.000000e+00 -9.250091e-11
#sdlog   -9.250091e-11  1.000000e+00



#Distribución Weillbul
fit_weillbul <- fitdist(easypay_usaSales/1000, "weibull")
summary(fit_weillbul)

#Parameters : 
#Loglikelihood:  -570742.1   AIC:  1141488   BIC:  1141507 
#Correlation matrix:
#          shape     scale
#shape 1.0000000 0.3311968
#scale 0.3311968 1.0000000
